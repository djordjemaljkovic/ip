...
<html>
    ...
    <body>
        ...
        <form action="moderator_pretragafajl.php" method="POST">
        <table id="tabela" class="nav sve">
            ...
            <tr>
                ...
                <td>
                    <input class="dugme" type="submit" name="moderatorPretragaPoNazivu" value="Pretrazi po nazivu"/><br/>
                </td>
            ...
            <tr>
                ...
                <td>
                    <input class="dugme" type="submit" name="moderatorPretragaPoAutoru" value="Pretrazi po autoru"/><br/>
                </td>
            </tr>
            <tr>
                <td>
        ...
        <form action="moderator_naprednapretragafajl.php" method="POST">
        <table id="tabela" class="nav sve">
            <th>
                PRONADJITE KNJIGU
            </th>
            ...
            <tr>
                ...
                <td>
                    <input class="dugme" type="submit" name="moderatorPretragaPoZanru" value="Pretrazi po zanru"/><br/>
                </td>
            ...
            <tr>
                ...
                <td>
                    <input class="dugme" type="submit" name="moderatorPretragaPoGodini" value="Pretrazi po godini"/><br/>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input class="dugme" type="submit" name="moderatorPretragaPoIzdavacu" value="Pretrazi po izdavacu"/><br/>
                </td>
            </tr>
            <tr>
                <td>
